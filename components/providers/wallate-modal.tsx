...
export function WalletModal() {
  ...
  const { privateKey, setPrivateKey, walletType, clearWallet, getKeypair } = useWalletStore()
  ...
  const connectWithPrivateKey = () => {
    ...
    try {
      ...
      toast.success("Connected with private key successfully", {
        description: `Address: ${keypair.publicKey.toString().slice(0, 8)}...${keypair.publicKey.toString().slice(-8)}`,
      })
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Connect your Solana wallet to continue</DialogDescription>
        </DialogHeader>
